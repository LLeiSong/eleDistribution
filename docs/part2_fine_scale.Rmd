...
ggarrange(plotlist = fg_list, ncol = 3, nrow = 8, 
          common.legend = TRUE, legend = "bottom")

fg_path <- here("docs/figures")
ggsave(file.path(fg_path, "vars_occ_range.png"), 
       width = 8, height = 12, dpi = 500, bg = "white")
...
ggarrange(plotlist = dist_fg_list, ncol = 3, nrow = 2, 
          common.legend = TRUE, legend = "bottom")

fg_path <- here("docs/figures")
ggsave(file.path(fg_path, "dist_vars_occ_range.png"), 
