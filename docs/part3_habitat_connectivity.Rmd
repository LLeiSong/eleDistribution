---
title: 'Part3: Landscape connectivity analysis'
author: "Lei Song"
date: "7/27/2022"
...
Then get farmland and settlement coverage layer.
...
The get the settlement density.
...
# No barriers
habitat_clusters <- rast(file.path(
    cnt_path, "habitat_clusters_original.asc"))
curmap_original <- rast(
    file.path(cnt_exp_path, "original_max_curmap.asc"))
curmap_original <- mask(curmap_original, habitat_clusters, 
                        inverse = TRUE, updatevalue = NA)
curmap_original <- norm_rast(curmap_original)
writeRaster(curmap_original, 
...
# No barriers
curmap_original_s1 <- rast(
    file.path(cls_path, "original",
              "cum_curmap_original_cluster1.tif"))
curmap_original_s1 <- mask(curmap_original_s1, bry)
curmap_original_s1 <- norm_rast(curmap_original_s1)
writeRaster(curmap_original_s1, 
            file.path(cls_path, "c1_connectivity_no_barriers.tif"))
```
...
# No barriers
curmap_original_s2 <- rast(
    file.path(cls_path, "original",
              "cum_curmap_original_cluster2.tif"))
curmap_original_s2 <- mask(curmap_original_s2, bry)
curmap_original_s2 <- norm_rast(curmap_original_s2)
writeRaster(curmap_original_s2, 
            file.path(cls_path, "c2_connectivity_no_barriers.tif"))
```
...
# No barriers
curmap_original_s3 <- rast(
    file.path(cls_path, "original",
              "cum_curmap_original_cluster3.tif"))
curmap_original_s3 <- mask(curmap_original_s3, bry)
curmap_original_s3 <- norm_rast(curmap_original_s3)
writeRaster(curmap_original_s3, 
            file.path(cls_path, "c3_connectivity_no_barriers.tif"))
```